...
//		hittables->add(std::make_shared<Sphere>(Point(0.0, 150.0, 145.0), 49.8, std::make_shared<Metal>(Colour(0.8, 0.8, 0.9), 1.0)));
...
//		hittables->add(std::make_shared<Sphere>(Point(0.0), 277.0, std::make_shared<ConstantMedium>(0.0001, Colour(1.0))));
		...
		auto white = std::make_shared<Lambertian>(Colour(0.73));
		int ns = 1000;
